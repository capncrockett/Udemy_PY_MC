def banner_text(text: str = " ", screen_width: int = 80) -> None:
    # """
    # Creates a banner for text.
    #
    # The function embeds text inside of a star studded banner.
    #
    # :param text: The line of text to print.
    # :param screen_width: Int value.
    # :raises ValueError: Line exceeds specified width (default 80 - 4).
    # """
...
banner_text("And... always look on the bright sid of life...", 60)
banner_text("*", 60)
